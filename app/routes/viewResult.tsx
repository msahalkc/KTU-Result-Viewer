...
export default function ViewResult() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-5 w-full">
      <div className="w-[75%] flex-1 flex flex-col items-center justify-center  gap-5">
      <h2 className="font-semibold">{responseData.resultName}</h2>
      <Card className="w-full">
        <CardBody className="flex flex-col gap-2">
          <div className="flex">
            <p className="w-[50%]">Name</p>
            <p>:</p>
            <p className="w-[50%] font-semibold">{responseData.firstName}</p>
          </div>
          <div className="flex">
            <p className="w-[50%]">College</p>
            <p>:</p>
            <p className="w-[50%] font-semibold">{responseData.institutionName}</p>
          </div>
          <div className="flex">
            <p className="w-[50%]">Register Number</p>
            <p>:</p>
            <p className="w-[50%] font-semibold">{responseData.registerNo}</p>
          </div>
          <div className="flex">
            <p className="w-[50%]">Semester</p>
            <p>:</p>
            <p className="w-[50%] font-semibold">{responseData.semesterName}</p>
          </div>
          <div className="flex">
            <p className="w-[50%]">Branch</p>
            <p>:</p>
            <p className="w-[50%] font-semibold">{responseData.branchName}</p>
          </div>
          <div className="flex">
            <p className="w-[50%]">Exam Month and Year</p>
            <p>:</p>
            <p className="w-[50%] font-semibold">{responseData.examYearAndMonth}</p>
          </div>
          <div className="flex">
            <p className="w-[50%]">Exam</p>
            <p>:</p>
            <p className="w-[50%] font-semibold">{responseData.resultName}</p>
          </div>
        </CardBody>
      </Card>
